...
//    constexpr float robotSize = 22.5;
  ...
  //  constexpr float fronSensorToFrontOfCannonDist = 8;
    ...
    constexpr double MOTOR_POSITION_ERROR = 4; //deviation in degrees from where the motor is set to be NOTE: if made too small the motor's accuraccy won't be abe to keep up and, among other things, the auton will be stuck trying to reach it''s set point forever
