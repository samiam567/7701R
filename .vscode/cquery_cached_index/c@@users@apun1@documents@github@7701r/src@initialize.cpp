...
std::vector<std::string> autonNames = {"backup","left-near","right-near","left-far-park","right-far-park","far-noPark","exFarLeft","exFarRight","Skills","callibration","none","tests"};
