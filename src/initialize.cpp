...
//  (name, drive_type,n shiftButton, ramp_up, ramp_down,intake_up, intake_down, intake_in, intake_out, LAUNCH_AUTON, BREAKS_ON, BREAKS_OFF)

//drivers
namespace GEAH {
driver Alec{"Alec \"Maverick\" Pannunzio",0,getButtonObject("c0X"),getButtonObject("c0R1"),getButtonObject("c0R2"),getButtonObject("c0UP"),getButtonObject("c0DOWN"),getButtonObject("c0L1"),getButtonObject("c0L2"),getButtonObject("sc0UP"),getButtonObject("notAssigned"),getButtonObject("notAssigned")};
driver Jay{"Jay \"TheCoolest\" ",0,getButtonObject("c0X"),getButtonObject("c0R1"),getButtonObject("c0R2"),getButtonObject("c0UP"),getButtonObject("c0DOWN"),getButtonObject("c0L1"),getButtonObject("c0L2"),getButtonObject("sc0UP"),getButtonObject("notAssigned"),getButtonObject("notAssigned")};
